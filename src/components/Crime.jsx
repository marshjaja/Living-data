...
// import { Card, Collapse, Image } from "react-bootstrap";
// import BarChart from "./Chart/BarChart"; // Import the BarChart component
// import DonutChart from "./Chart/DonutChart"; // Import the DonutChart component
...
//     useEffect(() => {
//         // Generate data for the donut chart and update state
//         if (Object.keys(crimeCounts).length > 0) {
//             const labels = Object.keys(crimeCounts);
//             const data = Object.values(crimeCounts);
...
//                 </div>
//             )}
//             {/* Render the DonutChart component */}
//             {donutChartData && (
//                 <div>
//                     <h3>Donut Chart</h3>
...
import React, { useState, useEffect } from "react";
import { boroughCoordinates, neighbourhoodsData } from "../../data/neighbourhoodData";
import InputGroup from "react-bootstrap/InputGroup";
import FormControl from "react-bootstrap/FormControl";
import Button from "react-bootstrap/Button";
import Alert from "react-bootstrap/Alert";
