...
const Header = () => {
  return (
    <div>
      ...
      <div className="container hero-image">
        <div className="row">
          <div className="col-lg-6 mb-3 d-flex justify-content-center mt-4">
            <div className="col-lg-6 mb-3 d-flex justify-content-center mt-3"></div>
          </div>
              ...
              <div className="container-fluid sm-py-1 py-5">
                ...
                <article>
                  ...
                  >
                    ...
                    <br />
                    Are you looking for your next rental, but you're tired of
                    opening hundreds of tabs on your browser to get as many info
                    about the area you're checking out? <br />
                    With LivingData
                    <br />
                    you only need to type once et Voila! All you need is already
                    there.
                  </h5>
                </article>
                <a href="#about" className="btn-header mt-3 learn-more">
                  Learn More
      ...
      <div className="container-fluid custom-bg search-bar"></div>
    </div>
  );
};
